...
import {GET_FILTER_PLATFORM,GET_TOP_GAME,GET_LOADER,GET_CHARACTER_BY_ID,GET_CHARACTERS_BY_NAME,GET_PLATFORMS,GET_CHARACTERS,GET_GENRES,GET_GENRES_FILTER,GET_ORDER_CHARACTERS,GET_VIDEOGAME_CREATE,GET_ORDER_RATING_CHARACTERS } from "../Variables";
...
export const getFilterPlatform=(payload)=>{
  return{
    type:GET_FILTER_PLATFORM,
    payload:payload
 }
}